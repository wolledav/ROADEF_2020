...
typedef vector<half_fitness_t> half_fitness_vector_t;
...
class Instance {
    private:
        ...
        vector<pair<uint_t, fitness_t>> avg_deltas; /* vector of pairs <intervention, avg_delta>, sorted by avg_deltas */
        vector<pair<uint_t, fitness_t>> avg_costs; /* vector of pairs <intervention, avg_delta>, sorted by avg_costs */
        vector<pair<uint_t, fitness_t>> avg_rds; /* vector of pairs <intervention, avg_delta>, sorted by avg_rds */
    ...
    public:
        ...
        void set_eval_parameters(fitness_t quantile, fitness_t alpha, uint_t comp_time); /* loads parameters used for evaluation */
        ...
        void add_r(uint_t intervention, uint_t resource, uint_t index, half_fitness_t r);
        ...
        fitness_t get_quantile();
        fitness_t get_alpha();
        uint_t get_computation_time();

        void set_avg_deltas(vector<pair<uint_t, fitness_t>> avg_deltas);
        void set_avg_costs(vector<pair<uint_t, fitness_t>> avg_costs);
        void set_avg_rds(vector<pair<uint_t, fitness_t>> avg_rds);
        const vector<pair<uint_t, fitness_t>>& get_avg_deltas() const;
        const vector<pair<uint_t, fitness_t>>& get_avg_costs() const;
        const vector<pair<uint_t, fitness_t>>& get_avg_rds() const;
    ;
};
